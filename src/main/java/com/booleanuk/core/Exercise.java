...
public class Exercise extends ExerciseBase {
     ...
     */
    public boolean hasKey(HashMap<String, String> person, String attribute) {
        return person.containsKey(attribute);
    }
    ...
    public int getValueOrDefault(HashMap<String, Integer> person, String attribute) {
        return person.getOrDefault(attribute,-1);
    }
