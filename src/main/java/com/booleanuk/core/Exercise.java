...
public class Exercise extends ExerciseBase {
     ...
     */
    public boolean hasKey(HashMap<String,String> hm, String key)  {
     ...
     */
    public int getValueOrDefault(HashMap<String, Integer> hm, String key)   {
        if(hm.get(key) != null) return hm.get(key);
        else return -1;
    }
