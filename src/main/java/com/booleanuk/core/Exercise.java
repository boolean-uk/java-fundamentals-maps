...
public class Exercise extends ExerciseBase {
     ...
     */
        public boolean hasKey(HashMap<String, String> pairs, String val) {
     ...
     */
        public int getValueOrDefault(HashMap<String, Integer> pairs, String val) {
            return pairs.getOrDefault(val, -1);
        }
