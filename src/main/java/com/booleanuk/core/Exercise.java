...
public class Exercise extends ExerciseBase {
    ...
    public boolean hasKey(HashMap<String, String> someMap, String key) {
        return someMap.containsKey(key);
    }
     ...
     */
    public int getValueOrDefault(HashMap<String, Integer> someMap, String key) {
        return someMap.getOrDefault(key, -1);
    }
